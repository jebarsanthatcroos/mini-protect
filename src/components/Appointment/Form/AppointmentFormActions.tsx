    ...
    >
      <div className='space-y-3'>
        ...
        <button
          ...
          onClick={onCancel}
          disabled={saving}
          className='w-full px-4 py-3 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
        >
          Cancel
        </button>
      </div>
